/*  Sitemap for blogger */
/*  Modified by WAHYU ADHY WICAKSONO */
/*  Thanks to duarupa*/
...
function loadtoc(a) {
    ...
    tocLoaded = true;
    displayToc2();
    document.write('</br><a href="http://templateyolo.blogspot.com/" style="font-size: 10px; text-decoration:none; color: #616469;">Sitemap</a>')
}
...
function displayToc(a) {
    ...
    for (var g = 0; g < postTitle.length; g++) {
        if (a == "") {
            h += '<tr><td class="toc-entry-col1"><a href="' + postUrl[g] + '">' + postTitle[g] + '</a></td><td class="toc-entry-col2">' + postDate[g] + '</td><td class="toc-entry-col3">' + postLabels[g] + '</td></tr>';
            l++
        } else {
